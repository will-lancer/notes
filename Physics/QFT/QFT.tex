...
\begin{enumerate}
    ...
    \begin{align*}
        U(\Lambda, a) \hat{\phi}(x) U(\Lambda, a)^{-1} = \hat{\phi}(\Lambda x + a).
    \end{align*}
...
massive $D = 3$, etc.). So, $U(W)$ can't change $\bfk_R$, but it
can change our $\sigma$ labels; thus, the $\sigma$ labels tell you
how the particle transforms under the little group. The operator
$U(W)$ generically gives a combination of particles with the same
$\bfk_R$ but different $\sigma$ labels, which we may write as
\begin{align*}
