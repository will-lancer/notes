...
\,:\!\phi(x+\varepsilon)\,\phi(x)\!:\; +\;
\big\langle \phi(x+\varepsilon)\,\phi(x)\big\rangle ,
\label{eq:wick-split}
\end{equation}
...
\begin{equation}
R\big[\op_k\big] \;=\; b^{-\Delta_k}\, \op_k ,
\qquad b = 3 \;\;\text{(the blocking factor)},
...
\begin{equation}
\big\langle \op_k(0)\,\op_k(r) \big\rangle
\;=\; b^{-2n\Delta_k}\,\big\langle \op_k(0)\,\op_k(r/b^n) \big\rangle
\qquad\Longrightarrow\qquad
\big\langle \op_k(0)\,\op_k(r) \big\rangle \;\propto\;
\frac{1}{r^{2\Delta_k}}\,,
...
\Big[\, 1 \,+\, O\big((a/r)^{\Delta_{\sigma'} - \Delta_\sigma}\big) \Big],
...
\begin{equation}
\big\langle \op_1(\lambda x_1)\, \op_2(\lambda x_2) \cdots
\op_n(\lambda x_n)\big\rangle
\;=\; \lambda^{-(\Delta_1 + \Delta_2 + \cdots + \Delta_n)}\,
\big\langle \op_1(x_1)\, \op_2(x_2)\cdots \op_n(x_n)\big\rangle ,
...
W(x) \;=\; \sum_\lambda \int
\frac{d^{d-1}p}{(2\pi)^{d-1}\,2E_\lambda(\mathbf p)}\;
\big|\bra{0}\op(0)\ket{\lambda,\mathbf p}\big|^2 \, e^{ip\cdot x}.
\label{eq:kl-step}
\end{equation}
...
\begin{equation}
\rho(s) \;\equiv\; \sum_\lambda \big|\bra{0}\op(0)\ket{\lambda}\big|^2\,
\delta\big(s - m_\lambda^2\big) \;\ge\; 0,
...
\qquad \lambda_i \in \complex\setminus\{0\},
...
\big[\, g^{ij}\partial_i\phi\,\partial_j\phi + m^2\phi^2\big]$ involves the
...
\begin{equation}
S[\phi] = \frac{1}{2}\int d^dy \;\Big(\prod_k \lambda_k^{1/2}\Big)
...
\begin{equation}
\Big|\arg \frac{\prod_k \lambda_k^{1/2}}{\lambda_i}\Big| < \frac\pi2
\quad\text{for each } i,
\qquad\text{i.e.}\qquad
\Big|\, \tfrac12 \textstyle\sum_{k \ne i} \arg\lambda_k - \tfrac12
...
\cdots < i_{p+1}\}$ has coefficient $\big(\prod_k \lambda_k^{1/2}\big) /
...
\begin{equation}
\op_i(x)\,\op_j(0) \;=\; \sum_{\op\ \rm primary}
