...
\roadchapter{II.2}{Gauging and 't Hooft anomalies}
...
\roadchapter{II.3}{Higher-form symmetries and the global structure of gauge theories}
...
\roadchapter{II.4}{Non-invertible symmetries}
...
\roadchapter{II.5}{The Symmetry Topological Field Theory}
...
\roadchapter{II.6}{Anomalies in parameter space}
...
\roadchapter{II.7}{The generalized Landau paradigm}
...
% =====================================================================
\roadpart{VI}{Exactly Solvable Corners: Supersymmetry and Friends}
...
\roadchapter{VI.1}{Holomorphy and Seiberg duality}
...
\roadchapter{VI.2}{Seiberg--Witten theory}
...
\roadchapter{VI.3}{Localization and exact partition functions}
...
\roadchapter{VI.4}{Theories without Lagrangians}
...
\roadchapter{VI.5}{Protected subsectors and integrability}
...
\roadchapter{VII.2}{The 2+1d duality web}
...
\roadchapter{VII.3}{Duality from gauging}
...
\roadchapter{IX.2}{The algebraic viewpoint}
...
\roadchapter{IX.3}{Information-theoretic theorems}
...
\roadchapter{IX.4}{Coupling to gravity: the crossed product}
...
% =====================================================================
\roadpart{X}{Scattering, the UV, and the Space of Consistent Theories}
...
\roadchapter{X.1}{The S-matrix bootstrap}
...
\roadchapter{X.2}{Positivity and the UV--IR connection}
...
\roadchapter{X.3}{Toward flat-space holography}
...
% =====================================================================
\roadpart{XI}{Large $N$, Holography, and Gravity}
