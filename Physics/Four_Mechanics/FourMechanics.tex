...
of statistical mechanics, as the world is fundamentally quantum mechanical,
treating the microscopic dynamics as \emph{classical} is oftentimes an almost
perfect approximation to the quantum mechanical theory, and thus we also define
the \emph{Hamiltonian}, $H$. Note that two completely different microscopic
theories can give the same coarse-grained result is because of the renormalization
group---averaging out the fast degrees of freedom gives basically the same effective theory.
